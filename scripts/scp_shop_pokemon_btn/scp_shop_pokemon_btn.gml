...
scp_shop_define_col_row()
	...
	#endregion
	#region row 4
		scp_shop_pokemon_btn_function(1,4,"machop",spr_button_orange)
	...
	#region row 6
		...
		scp_shop_pokemon_btn_function(2,6,"eevee",spr_button_white)
		scp_shop_pokemon_btn_function(3,6,"houndour",spr_button_black)
		scp_shop_pokemon_btn_function(4,6,"teddiursa",spr_button_white)
